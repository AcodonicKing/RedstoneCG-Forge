...
public class RedstonecgModMenus {
	...
	public static final RegistryObject<MenuType<RedCuCrafterGUIMenu>> REDCU_CRAFTER_GUI = REGISTRY.register("redcu_crafter_gui", () -> IForgeMenuType.create(RedCuCrafterGUIMenu::new));
